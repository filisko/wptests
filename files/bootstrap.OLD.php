...
require_once __DIR__ . '/core/mock-mailer.php';
...
if ( version_compare( tests_get_phpunit_version(), '6.0', '>=' ) ) {
	require __DIR__ . '/core/phpunit6/compat.php';
}

require_once __DIR__ . '/core/phpunit-adapter-testcase.php';
require_once __DIR__ . '/core/abstract-testcase.php';
require_once __DIR__ . '/core/testcase.php';
require_once __DIR__ . '/core/testcase-rest-api.php';
require_once __DIR__ . '/core/testcase-rest-controller.php';
require_once __DIR__ . '/core/testcase-rest-post-type-controller.php';
require_once __DIR__ . '/core/testcase-xmlrpc.php';
require_once __DIR__ . '/core/testcase-ajax.php';
require_once __DIR__ . '/core/testcase-canonical.php';
require_once __DIR__ . '/core/testcase-xml.php';
require_once __DIR__ . '/core/exceptions.php';
require_once __DIR__ . '/core/utils.php';
require_once __DIR__ . '/core/spy-rest-server.php';
require_once __DIR__ . '/core/class-wp-rest-test-search-handler.php';
require_once __DIR__ . '/core/class-wp-rest-test-configurable-controller.php';
require_once __DIR__ . '/core/class-wp-fake-block-type.php';
require_once __DIR__ . '/core/class-wp-sitemaps-test-provider.php';
require_once __DIR__ . '/core/class-wp-sitemaps-empty-test-provider.php';
require_once __DIR__ . '/core/class-wp-sitemaps-large-test-provider.php';
